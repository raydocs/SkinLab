...
struct EnhancedIngredientResultView: View {
    ...
    enum ResultTab: String, CaseIterable {
        ...
        var icon: String {
            switch self {
            case .overview: "doc.text.fill"
            case .aiInsight: "sparkles"
            case .function: "square.grid.2x2.fill"
            case .personalized: "person.fill"
            }
        }
    }
        ...
        VStack(spacing: 16) {
            ...
            if enhancedResult.hasPersonalizedInfo {
                ...
                Text(enhancedResult.suitableForUser ? "适合你的肤质" : "需要谨慎使用")
                    ...
                    .padding(.vertical, 8)
                    .background((enhancedResult.suitableForUser ? Color.skinLabSuccess : Color.skinLabWarning)
                        .opacity(0.1))
                    .cornerRadius(12)
            }
    ...
    private var overviewTab: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            if let aiResult, !aiResult.evidence.isEmpty {
    ...
    private func evidenceSection(aiResult: IngredientAIResult) -> some View {
        ...
        .background(LinearGradient(
            colors: [Color.skinLabPrimary.opacity(0.05), Color.skinLabSecondary.opacity(0.05)],
