    ...
    private func detectWithZScore(
        ...
        for i in 0 ..< values.count {
            ...
            if abs(zScore) > threshold {
                let severity: AnomalyDetectionResult.Severity = if abs(zScore) > 3.5 {
                    .severe
    ...
    private func detectWithMAD(
        ...
        for i in 0 ..< values.count {
            ...
            if abs(modifiedZScore) > threshold {
                let severity: AnomalyDetectionResult.Severity = if abs(modifiedZScore) > 4.0 {
                    .severe
    ...
    private func detectWithIQR(
        ...
        for i in 0 ..< values.count {
            ...
            if value < lowerBound || value > upperBound {
                let severity: AnomalyDetectionResult
                    .Severity = if value < extremeLowerBound || value > extremeUpperBound {
                    .severe
                } else {
                    .mild
                }
